...
const OUTPUT = "/tmp/agentshield/reports/dify-plugins-report.md";
...
md += `3. Add \`.agentshield.yml\` config to customize severity thresholds per plugin\n`;
md += `\n---\n\n*Generated by [AgentShield](https://github.com/elliotllliu/agentshield) v0.3.0*\n`;

mkdirSync(join("/tmp/agentshield/reports"), { recursive: true });
